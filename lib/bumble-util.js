...
(function() {
  var BStr, Fs, HOME_DIR, LAST_NPM_INSTALL_FILE, Moment, Path, Shell, _, handleError, installNodePackage, npmInstall, openTerminalTab, systemCmd;
  ...
  systemCmd = function(cmd, options) {
    ...
    try {
      ...
      e = _error;
      if (options.showOutput) {
        console.log((ref = e.stdout) != null ? ref.toString() : void 0);
        console.error((ref1 = e.stderr) != null ? ref1.toString() : void 0);
      }
      if (options.failOnError) {
        throw new Error(e);
      }
    }
    return (ref2 = out.stdout) != null ? ref2 : null;
  };
